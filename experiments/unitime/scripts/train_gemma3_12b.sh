#!/bin/bash
# UniTime + GEMMA3-12B training, GTEA dataset.
# Same as train_gemma3.sh but with 12B model.
# 12B hidden_size=3840 (vs 4B's 2560), needs re-extracted features.
#
# Prerequisites:
#   1. Extract Gemma3 12B features:
...
#            --feat_root  /nfs/hpc/share/zhanhaoc/MODLE/Gemma3-12B-it/features \
#            --model_local_path /nfs/hpc/share/zhanhaoc/MODLE/Gemma3-12B-it \
#            --dataset_name gtea --num_frames 32 --gpu 0
#
# How to run:
#     conda activate UniTime
#     cd experiments/unitime/UniTime
#     bash ../scripts/train_gemma3_12b.sh

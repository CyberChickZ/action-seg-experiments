#!/bin/bash
# UniTime training, GTEA dataset.
#
# Synced from Tieqiao Wang's TaCoS train.sh
#   (/nfs/stak/users/wangtie/2026/3/15/UniTime/scripts/train.sh)
# Only paths are swapped (TaCoS → GTEA) and CUDA_HOME is exported (deepspeed
# needs it for op-builder; not in upstream / Tieqiao's version).
#
# How to run on HPC (dgxh-1):
...
IMAGE_FOLDER=None
VIDEO_FOLDER=/nfs/hpc/dgx2-4/tmp/2026/4/6/video/gtea

#!/bin/bash
# UniTime + Qwen3-VL-2B training, GTEA dataset.
#
# REQUIRES UniTime-gemma4 env (transformers 5.x).
# Pixel-values path: collator loads frames from disk each step, no pre-extracted features.
#
# How to run:
...
#     bash ../scripts/train_qwen3vl_2b.sh
